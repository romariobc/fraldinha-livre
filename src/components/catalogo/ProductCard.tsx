...
export default function ProductCard({ product, onRequestOffer }: ProductCardProps) {
    ...
    <div className="bg-white rounded-card shadow-card overflow-hidden hover:-translate-y-1.5 hover:shadow-card-hover transition-all flex flex-col">
      ...
      <div className="p-3.5 sm:p-4 flex flex-col flex-1">
        ...
        <div className="mt-auto">
          ...
          <button
            onClick={handleOffer}
            className="w-full py-2 rounded-full bg-accent text-white font-display font-bold text-sm hover:bg-accent-dark transition-colors"
          >
            Pedir oferta →
          </button>
        </div>
