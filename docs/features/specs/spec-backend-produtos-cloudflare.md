...
- Dívida original: `docs/design/adr/adr-001-estrategia-backend.md` (DEC-A do plano da fatia 1,
  `docs/features/plans/archive/B-backend-pedidos-breakdown.md`).
...
- Decisões da fatia 1: `docs/governance/decisoes.md` (D-026, D-027), `context/estado/progresso.md`.
