...
- Backend real de Produtos: `back/src/routes/products.ts`, `back/src/schema/products.ts` (fatia P1-P3,
  `docs/features/plans/P1-products-schema-seed.md`).
- Padrao porta+adapter e auth: `docs/backend/integration-guide.md`,
  `spec-backend-pedidos-cloudflare.md`.
- Governanca: `docs/governance/decisoes.md` (D-001, D-005, D-023, D-024, D-026, D-027).
