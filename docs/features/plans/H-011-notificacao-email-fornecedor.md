...
**Spec:** `docs/features/specs/spec-fornecedor-notificacao-email.md` (aprovada 2026-07-30)
...
- D-031 (`docs/governance/decisoes.md`) registra um bug real de migration D1/SQLite
