...
Specs de design ficam em `docs/features/specs/` (neste repo) e sao a referencia obrigatoria do spec-driven development. Copia de backup mantida no harness de referencia (`dev_flow_create_harness`). Planos/prompts de implementacao ficam em `docs/features/plans/`.
...
- **Sessoes Haiku:** executam exatamente o que o prompt em `docs/features/plans/` pede, relatam o que foi feito.
- Toda entrega Haiku so e considerada completa apos revisao aprovada na sessao-mae.
- Cada sessao significativa e documentada em `context/chatsessions/` e o estado em `context/estado/` e atualizado antes de encerrar.
...
Template padrao em `docs/features/plans/README.md`.
...
- Spec da feature 014: `docs/features/specs/spec-catalogo-compra-direta.md`.

## D-012 — Checklist de revisao pre-aprovacao obrigatorio (2026-07-02) — VIGENTE

Toda entrega de sessao Haiku passa pelo `docs/governance/review-checklist.md` ANTES de a sessao-mae
...
`docs/architecture/blueprint-arquitetura-2026-07-29.html`) e ataque aos pontos
...
## D-056 — Harness agnóstico e contexto seletivo (2026-09-21) — VIGENTE
