...
| [spec-backend-pedidos-cloudflare.md](spec-backend-pedidos-cloudflare.md) | 006 (fatia 1) — backend de pedidos em Cloudflare Workers + D1 (resolve D-026) | rascunho (2026-07-17) |
