...
- Nota crítica de escopo: `context/estado/progresso.md` (entrada da feature 006, 2026-07-23) e
...
- Decisão de modelo multi-vendedor: `docs/governance/decisoes.md` D-009 (Modelo A).
