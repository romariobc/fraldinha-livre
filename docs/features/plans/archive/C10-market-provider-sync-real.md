...
**Spec:** `docs/design/specs/spec-catalogo-fornecedor-produtos.md` (APROVADA) — tarefa C10 de
`docs/design/plans/C-catalogo-fornecedor-breakdown.md` (dependência: C7 commit `1543b08` +
