...
As definições estão localizadas em [src/schema/](../../back/src/schema).

### 2.1 Tabela: `products`
Armazena o catálogo de fraldas e produtos disponíveis para venda.

* **Arquivo de Origem**: [products.ts](../../back/src/schema/products.ts)
* **Estrutura**:
...
* **Arquivo de Origem**: [orders.ts](../../back/src/schema/orders.ts)
* **Estrutura**:
...
* **Arquivo de Origem**: [reports.ts](../../back/src/schema/reports.ts)
* **Estrutura**:
...
* **Regras de Acesso (Firestore Security Rules)**:
  * Localizadas em [firestore.rules](../../firestore.rules).
...
* **Arquivo de Origem**: [auth-context.tsx](../../front/src/contexts/auth-context.tsx#L39-L61)
...
As validações de integridade de dados e requisições HTTP ocorrem usando schemas Zod compartilhados em [packages/contracts/src/](../../packages/contracts/src).
