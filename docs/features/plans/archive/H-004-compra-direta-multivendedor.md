...
**Spec:** `docs/design/specs/spec-catalogo-compra-direta.md` (APROVADA 2026-07-02, com nota de implementacao) — LEIA A SPEC INTEIRA ANTES DE COMECAR. Em conflito entre prompt e spec, a spec vence; pare e relate.
