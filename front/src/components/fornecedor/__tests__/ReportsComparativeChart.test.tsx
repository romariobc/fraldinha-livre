...
import { ReportsComparativeChart, type ReportDataPoint } from '../ReportsComparativeChart'
...
describe('ReportsComparativeChart Component', () => {
  it('renders title, description and header summary pills accurately', () => {
    ...
    expect(screen.getByText('Comparativo: Entregas vs Cancelamentos')).toBeInTheDocument()
    expect(screen.getByText('Evolução temporal do volume de entregas bem-sucedidas vs cancelamentos operacionais.')).toBeInTheDocument()
  ...
  it('renders the chart container and responsive chart wrapper', () => {
    render(<ReportsComparativeChart data={MOCK_REPORT_DATA} />)
